...
(function ($) {
	...
	$.Rotator = $.Plugin.extend(function () {

		this.version = '0.9.8 R05.06.13';
		...
		var init = function () {
			...
			// get the slides
			base.$slides = base.$el.find(config.slideClass);
		...
		base.ieFadeFix = function (enable) {
			...
			base.$el.css({ backgroundColor: (enable) ? 'black' : 'transparent' });
			return base;
		};
		...
		base.trigger = function (name, data) {
